...
function replaceThumbnailWithIframe(e){
  ...
  if (target.className.match(/BetterTube-playBtn/)){
    ...
    inner = '<iframe class="youtubePlayer" src="https://www.youtube.com/embed/' + id + '?autoplay=1&border=0&wmode=opaque&enablejsapi=1"' + style + ' allowfullscreen="allowfullscreen" />'
